...
class Agent:
    def make_model(self, activation_function='tanh'):
        ...
        model.add(Flatten()) # input the observations
        model.add(Dense(units= 16, activation=activation_function)) # hidden
        model.add(Dense(units= 8, activation=activation_function)) # hidden
